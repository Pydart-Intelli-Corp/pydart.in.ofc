                            ...
                            <div className="heading-wrap-content">
                                <div className="sec-heading style-2">
                                    <h2 className="sec-title text-anim">
                                        Healthcare Robotics <span style={{ color: 'var(--tj-color-theme-primary)' }}>Insights.</span>
                                    </h2>
                                </div>
                                <div className="wow fadeInUp" data-wow-delay=".5s">
                                    <p className="desc">
                                        Explore the latest research, technology breakthroughs, and real-world impact of robotic patient transfer systems in Indian healthcare.
                                    </p>
                                </div>
                                <div
